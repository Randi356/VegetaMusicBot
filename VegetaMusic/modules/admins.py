...
from VegetaMusic.config import BOT_USERNAME
from VegetaMusic.function.admins import set
from VegetaMusic.helpers.channelmusic import get_chat_id
from VegetaMusic.helpers.decorators import authorized_users_only
from VegetaMusic.helpers.filters import command, other_filters
from VegetaMusic.services.callsmusic import callsmusic
...
async def update_admin(client, message: Message):
    ...
    await message.reply_text("✅️ admins cache refreshed!")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("✅️ **Bot dimulai** ulang **berhasil**")
