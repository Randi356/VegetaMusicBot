...
from VegetaMusic.config import ARQ_API_KEY, DURATION_LIMIT, VEGETA, SUPPORT_GROUP
from VegetaMusic.config import UPDATES_CHANNEL as updateschannel
from VegetaMusic.config import que
from VegetaMusic.function.admins import admins as a
from VegetaMusic.helpers.admins import get_administrators
from VegetaMusic.helpers.channelmusic import get_chat_id
from VegetaMusic.helpers.decorators import authorized_users_only, errors
from VegetaMusic.helpers.errors import DurationLimitError
from VegetaMusic.helpers.filters import command, other_filters
from VegetaMusic.helpers.gets import get_file_name, get_url
from VegetaMusic.services.callsmusic import callsmusic, queues
from VegetaMusic.services.callsmusic.callsmusic import client as USER
from VegetaMusic.services.converter.converter import convert
from VegetaMusic.services.downloaders import youtube
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("👑owner", url="https://t.me/rencprx"),
...
async def ee(client, message):
    ...
    if stats:
        ...
        await message.reply("**Silahkan Nyalakan dulu VCG kntl!**")
...
async def p_cb(b, cb):
    ...
    if type_ == "playlist":
        ...
        if not queue:
            await cb.message.edit("**playlist 404**")
        temp = []
        for t in queue:
            temp.append(t)
        now_playing = temp[0][0]
...
async def play(_, message: Message):
    ...
    text_links = None
    await lel.edit("🔎 **Prossing Search**")
    message.from_user.id
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/5b1412cf1b4b3cf1ce5bb.jpg"
        ...
        query = toxt
        await lel.edit("🎵 **Prossing Vegeta**")
